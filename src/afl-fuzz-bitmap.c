...
static const u8 count_class_lookup8[256] = {
    ...
    [8 ... 15] = 4,     // 8–15  -> bucket 4
    [16 ... 31] = 8,    // 16–31 -> bucket 8
    [32 ... 63] = 16,   // 32–63 -> bucket 16
    ...
    [16 ... 31] = 4,   // 16–31 -> bucket 4
    [32 ... 63] = 8,   // 32–63 -> bucket 8
    [64 ... 95] = 16,  // 64–95 -> bucket 16 (split former 64–127)
