...
class ModuleSanitizerCoverageLTO
 ...
 private:
  ...
  // my map
  std::map<BasicBlock *, std::vector<std::pair<uint32_t, uint32_t>>>BBToTargetsMap;
};
...
bool ModuleSanitizerCoverageLTO::instrumentModule(
  ...
  */
  ...
  // march 22 2026 update: read target list from file generated by codeql query
  std::vector<TargetInfo> targets = {};
  std::string path = "targets.csv";
